...
public class Database extends SQLiteOpenHelper {
    ...
    //Database name
    private static String DATABASE_NAME = "readingStory";

    //Account table
    private static String TABLE_ACCOUNT = "account";
    private static String ID_ACCOUNT = "accountId";
    ...
    private static String ID_STORY = "storyId";
    private static String STORY_NAME = "title";
    ...
    //Create story table
    private String SQLQuery1 = "CREATE TABLE "+ TABLE_STORY +" ( "+ ID_STORY +" integer primary key AUTOINCREMENT, "
            + STORY_NAME +" TEXT UNIQUE, "
            + CONTENT +" TEXT, "
    ...
    private String SQLQuery2 = "INSERT INTO account VAlUES (null,'admin','admin','admin@gmail.com',2)";
    private String SQLQuery3 = "INSERT INTO account VAlUES (null,'user','user','user@gmail.com',1)";

    //Insert story
    private String SQLQuery4 = "INSERT INTO story VALUES (null,'Rùa và Thỏ','Phần 1:\n" +
            "\n" +
    ...
    private String SQLQuery5 = "INSERT INTO story VALUES (null,'Củ cải trắng','Mùa đông đã đến rồi trời lạnh buốt, Thỏ con không có gì để ăn cả. Thỏ con mặc áo vào rồi ra ngoài kiếm thức ăn. Nó đi mãi đi mãi cuối cùng cũng tìm được hai củ cải trắng. Thỏ con reo lên:\n" +
            "\n" +
    ...
    private String SQLQuery6 = "INSERT INTO story VALUES (null,'Dê đen và dê trắng','Dê đen và Dê trắng cùng sống trong một khu rừng. Hàng ngày, cả hai thường đến uống nước và tìm cái ăn ở trong khu rừng quen thuộc.\n" +
            "\n" +
    ...
    private String SQLQuery7 = "INSERT INTO story VALUES (null,'Chú bé chăn cừu','Một chú bé chăn cừu cho chủ thả cừu gần một khu rừng rậm cách làng không xa lắm. Chăn cừu được ít lâu, chú cảm thấy công việc chăn cừu thực là nhàm chán. Tất cả mọi việc chú có thể làm để giải khuây là nói chuyện với con chó hoặc thổi chiếc sáo chăn cừu của mình.\n" +
            "\n" +
    ...
    public void onCreate(SQLiteDatabase sql) {
        ...
        sql.execSQL(SQLQuery1);
        sql.execSQL(SQLQuery2);
        sql.execSQL(SQLQuery3);
        sql.execSQL(SQLQuery4);
        sql.execSQL(SQLQuery5);
        sql.execSQL(SQLQuery6);
        sql.execSQL(SQLQuery7);
        sql.execSQL(SQLQuery8);
    }
    ...
    public void addAccount(Account acc){
        ...
        //Insert using ContentValues
        ContentValues values = new ContentValues();
        values.put(ACCOUNT_NAME, acc.getUsername());
    ...
    //Get 3 newest story
    public Cursor getThreeNewestStory(){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM "+ TABLE_STORY + " ORDER BY " + ID_STORY + " DESC LIMIT 3", null);
        return res;
    }
    ...
    //Add story
    public void addStory(Story t){
        SQLiteDatabase db = this.getWritableDatabase();

        ContentValues values = new ContentValues();

        values.put(STORY_NAME, t.getTitle());
        values.put(CONTENT, t.getContent());
        values.put(IMAGE, t.getImage());
        values.put(ID_ACCOUNT, t.getId_acc());
    ...
    public int delete(int i){
        SQLiteDatabase db = this.getWritableDatabase();
        int res = db.delete(TABLE_STORY, ID_STORY + " = " + i, null);
        return res;
    }
}
