...
public class AllBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvAllBook = findViewById(R.id.lvAllBook);
        initViews();
        ...
        ApiService.apiService.isTokenValidation(PreferrenceUtils.getJwt(getApplicationContext())).enqueue(new Callback<Boolean>() {
            ...
            public void onResponse(Call<Boolean> call, Response<Boolean> response) {
                if (response.code() == 401) {
                    Intent intent = new Intent(AllBookActivity.this, LoginActivity.class);
            ...
            public void onFailure(Call<Boolean> call, Throwable t) {
                Toast.makeText(AllBookActivity.this, "Server is busy! Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void mapping() {
        ...
        ApiService.apiService.getAllBook(PreferrenceUtils.getJwt(this)).enqueue(new Callback<List<Book>>() {
            @Override
            public void onResponse(Call<List<Book>> call, Response<List<Book>> response) {
                if (response.isSuccessful()) {
                    listBook = (ArrayList<Book>) response.body();
                    adapterBook = new AdapterBook(getApplicationContext(), listBook);
                    lvAllBook.setAdapter(adapterBook);
                } else {
                    ...
                    try {
                        ...
                        Toast.makeText(AllBookActivity.this, errorException.getErrors().get(0), Toast.LENGTH_SHORT).show();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
            ...
            public void onFailure(Call<List<Book>> call, Throwable t) {
                Toast.makeText(AllBookActivity.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });


        lvAllBook.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(AllBookActivity.this, MediaActivity.class);
